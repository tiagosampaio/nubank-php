...
class ContainerRepository
{
     ...
     *
     * @return \DI\Container
     * @throws \Nubank\Framework\Exception\ExceptionInterface
     */
    ...
    private static function buildInstance(array $config = [])
    {
        ...
        try {
            ...
            /** @todo Throw new \Nubank\Framework\Exception\ExceptionInterface instance. */
        }
    }
